...
public class Validate_Assessment extends BaseClass{
	...
	public void assessmentTest() {
		...
		{
			System.out.println("The Release Date present in both Wiki and imdb is same");
		}
		else
		{
			System.out.println("The Release date present in both Wiki and imdb is not same");
		}
